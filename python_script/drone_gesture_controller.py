...
def my_callback(channel):
	if GPIO.input(6) == GPIO.HIGH:
		...
		if data() == "L" :
			drone.moveLeft()               # Drone moves full speed to the left...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
		elif data() == "R":
			drone.moveRight()               # Drone moves full speed to the Right...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
		elif data() == "U":
			drone.moveForward()               # Drone moves full speed to the Forward...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
		elif data() == "D":
			drone.moveBackward()               # Drone moves full speed to the Backward...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
		elif data() == "C":
			drone.turnRight()               # Drone moves full speed to the Right Rotation...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
		elif data() == "W":
			drone.turnLeft()               # Drone moves full speed to the Left Rotation...
			time.sleep(3)                  # ... for two seconds
			drone.stop()                   # Drone stops
			time.sleep(2)
